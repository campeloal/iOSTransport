...
@property (nonatomic) NSMutableArray *streets;
...
- (void)viewDidLoad {
    ...
    _streets = [[NSMutableArray alloc] initWithObjects:@"OI", nil];
    
    _streetsTableView.delegate = self;
}
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [self.streets objectAtIndex:indexPath.row];
